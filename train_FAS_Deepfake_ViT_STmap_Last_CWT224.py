...
from models.ResNet_Xception import ViT_STmap_LastCWT
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log', type=str, default="ViT_Last_FAS_Deepfake_Joint_STmap_CWT224", help='log and save model name')
