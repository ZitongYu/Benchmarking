...
def train_test():
    ...
    if finetune==True:
        ...
        model = ViT_STmap_LastCWT(pretrained=True)
    ...
    for epoch in range(args.epochs):  # loop over the dataset multiple times
        ...
        # first  FAS
        train_data = Spoofing_train(train_FAS_list, root_FAS_Deepfake_dir, transform=transforms.Compose([ ToTensor(),  Normaliztion()]))
        ...
        # then DF
        train_data = Spoofing_train(train_Deepfake_list, root_FAS_Deepfake_dir, transform=transforms.Compose([ ToTensor(),  Normaliztion()]))
        dataloader_train = DataLoader(train_data, batch_size=args.batchsize, shuffle=True, num_workers=4)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log', type=str, default="ViT_Last_FAS_Deepfake_Joint_STmap_CWT224_TaskbyTask_FAS_DF", help='log and save model name')
