...
from Load_FAS_ResNet_Xception_3class import Spoofing_train, Normaliztion, ToTensor, RandomHorizontalFlip, Cutout
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log', type=str, default="ViT_3class_FAS_Deepfake_Joint", help='log and save model name')
