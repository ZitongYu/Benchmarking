...
from models.ResNet_Xception import ViT_STmap_LastCWT_3class, ResNet18_STmap_LastCWT_3class


from Load_FAS_ResNet_Xception_STmap_CWTlast_3class import Spoofing_train, Normaliztion, ToTensor
...
def train_test():
    ...
    if finetune==True:
        ...
        model = ResNet18_STmap_LastCWT_3class(pretrained=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log', type=str, default="ResNet18_Last_FAS_Deepfake_Joint_STmap_CWT224_3class", help='log and save model name')
