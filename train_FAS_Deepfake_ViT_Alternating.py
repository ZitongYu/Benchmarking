...
def train_test():
    ...
    for epoch in range(args.epochs):  # loop over the dataset multiple times
        ...
        dataloader_train_FAS = DataLoader(train_data_FAS, batch_size=args.batchsize, shuffle=True, num_workers=4)
        ...
        dataloader_train_DF = DataLoader(train_data_DF, batch_size=args.batchsize, shuffle=True, num_workers=4)
        ...
        for i in range(iternum):
            ...
            logits =  model(image_x_FAS)
            
            loss_global =  criterion(logits, spoofing_label_FAS.squeeze(-1))
            ...
            logits =  model(image_x_DF)
            
            loss_global =  criterion(logits, spoofing_label_DF.squeeze(-1))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log', type=str, default="ViT_FAS_Deepfake_Joint_Alternating_FAS_DF", help='log and save model name')
