...
def train_test():
    ...
    for epoch in range(args.epochs):  # loop over the dataset multiple times
        ...
        for i in range(iternum):
            ...
            inputs2 = torch.cat([image_x_FAS2, image_x_DF2],0).cuda()
            ...
            logits1, logits2, logits_fuse =  model(inputs, inputs2) # [B*T, 2]

            
            loss1 =  criterion(logits1, spoof_label.squeeze(-1))
            loss2 =  criterion(logits2, spoof_label.squeeze(-1))
            loss3 =  criterion(logits_fuse, spoof_label.squeeze(-1))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log', type=str, default="ResNet18_Last_FAS_Deepfake_Joint_STmap_CWT224_Simult", help='log and save model name')
