...
def train_test():
    ...
    for epoch in range(args.epochs):  # loop over the dataset multiple times
        ...
        # first DF
        train_data = Spoofing_train(train_Deepfake_list, root_FAS_Deepfake_dir, transform=transforms.Compose([RandomHorizontalFlip(),  ToTensor(), Cutout(), Normaliztion()]))
        ...
        # then FAS
        train_data = Spoofing_train(train_FAS_list, root_FAS_Deepfake_dir, transform=transforms.Compose([RandomHorizontalFlip(),  ToTensor(), Cutout(), Normaliztion()]))
        dataloader_train = DataLoader(train_data, batch_size=args.batchsize, shuffle=True, num_workers=4)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log', type=str, default="ViT_FAS_Deepfake_Joint_TaskbyTask_DF_FAS", help='log and save model name')
